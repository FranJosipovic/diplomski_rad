  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <aside style={{
        ...
        {/* Logo */}
        <div style={{ padding: '28px 24px 20px', borderBottom: '1px solid var(--br-1)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              ...
              <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                <path d="M10 2 C10 2 4 8 4 12.5 A6 6 0 0 0 16 12.5 C16 8 10 2 10 2Z"
                  fill="none" stroke="var(--teal)" strokeWidth="1.5" strokeLinejoin="round" />
                <path d="M10 10 L10 16" stroke="var(--green)" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M7.5 13.5 L10 16 L12.5 13.5" stroke="var(--green)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 8 }}>
            ...
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9.5, color: 'var(--tx-2)', letterSpacing: '0.08em' }}>
              MQTT LIVE
            </span>
          </div>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 9.5, color: 'var(--tx-2)' }}>
            192.168.1.112:1883
          </div>
        </div>
      </aside>
